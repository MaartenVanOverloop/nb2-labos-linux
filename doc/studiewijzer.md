...
Vragen stellen over de leerstof of over de organisatie van de cursus kan tijdens de contactmomenten, op het [Chamilo-forum](), of via e-mail. Algemeen worden cursisten aangespoord om vragen te stellen via het forum, zodat iedereen het antwoord kan zien. Jammer genoeg krijgen de lectoren geen melding als er nieuwe berichten gepost worden. Het is dus nuttig om een seintje te geven via e-mail als een antwoord uitblijft. Sorry voor dit ongemak.
